...
- In the first cell of your new notebook, use the `wget` command to download the `dirty_employee_data` to your EC2 instance. The link is: `https://raw.githubusercontent.com/danilofreire/qtm350-summer/main/lectures/lecture-20/dirty_employee_data.csv`
