...
subtitle: Lecture 12 - Introduction to AI-Assisted Programming
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    footer: "[AI Programming](https://raw.githack.com/danilofreire/qtm350-summer/main/lectures/lecture-12/12-ai-programming.html)"
transition: slide
...
:::{style="text-align: center;"}
![](figures/copilot_chat_icon.png){width="20%"}
:::
...
- It is powered by [Bing](https://www.bing.com/), and it can also search the web for information
...
:::{.columns}
:::{.column width="33%"}
![](figures/github_search01.png){width="80%"}
:::

:::{.column width="33%"}
![](figures/github_search02.png){width="70%"}
:::

:::{.column width="33%"}
![](figures/github_search03.png){width="70%"}
:::
:::
:::
