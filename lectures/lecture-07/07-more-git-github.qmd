...
- But there's also [GitHub Copilot](https://copilot.github.com)
- It works really well! GitHub Copilot is an AI pair programmer that helps you write code
- Think about [ChatGPT](https://chat.openai.com) but integrated into your IDE
